...
|---|---|---|
| Architecture and decision register | Done | DEC-001–036 recorded; device-protection and decision-quality boundaries clarified. |
...
| D-03 | Record Netatmo rain entity IDs, units, timestamps, and update/deduplication semantics. | Not started | Choose one measured rain source for `rain_accumulation.py`. | D-01 |
